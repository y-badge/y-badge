...
filter_coefficients_t calculate_filter_coefficients(int cuttoff_freq, int sample_rate, bool high_pass) {
...
bool processWAVFile(const std::string &inputFilePath, const std::string &outputFilePath,int cuttoff_freq,bool high_pass) {
    ...
    filter_coefficients_t filter_coefficients_1 = calculate_filter_coefficients(cuttoff_freq, MIC_SAMPLE_RATE, high_pass);
    filter_coefficients_t filter_coefficients_2 = calculate_filter_coefficients(cuttoff_freq, MIC_SAMPLE_RATE, high_pass);
    filter_coefficients_t filter_coefficients_3 = calculate_filter_coefficients(cuttoff_freq, MIC_SAMPLE_RATE, high_pass);
